angular.module('app')
.controller('scanDataCtrl', ['$state', '$scope', '$timeout', '$interval', '$http', '$uibModal', '$q', '$rootScope', function($state, $scope, $timeout, $interval, $http, $uibModal, $q, $rootScope){
...
*/
       ...
       // exporterPdfHeader: { text: "Zoom Report", style: 'headerStyle' },
        ...
        columnDefs:[
            ...
            { field: 'pickup_timestamp', displayName : 'Delivery Date', width:100 },
            { field: 'partnername' , displayName:'Delivery Sift', width:170 },
            { field: 'delivery_name', displayName : 'Receiver Name', width:150 },
            { field: 'pickup_address', displayName:'Drop Off Address', width:150},
            { field: 'delivery_address', displayName : 'Address Info', width:150 },
            { field: 'pickup_address', displayName : 'Delivery Instruction', width:150 },
            { field: 'delivery_phone', displayName : ' Phone', width:150 },
            { field: 'delivery_email', displayName : ' Email', width:150 },
            { field: 'cod', displayName:'COD', width:100,  cellClass: 'grid-alignright', cellFilter: 'number: 2' },
            { field: 'delivery_email', displayName : ' Item Size', width:80 },
            { field: 'delivery_postalcode', displayName : ' Postal Code', width:80 },
            { field: 'delivery_postalcode', displayName : 'Reff Id', width:80 },
            { field: 'delivery_postalcode', displayName : 'Outlet Id', width:80 },
            { field: 'delivery_postalcode', displayName : 'Notes 1', width:80 },
            { field: 'delivery_postalcode', displayName : 'Sum Insured', width:80 },
            { field: 'delivery_postalcode', displayName : 'Customer', width:80 },
            { field: 'delivery_postalcode', displayName : 'Weight', width:80 },
            { field: 'delivery_postalcode', displayName : 'Lattitude', width:80 }, 
            { field: 'delivery_postalcode', displayName : 'Longitude', width:80 },
            { field: 'delivery_postalcode', displayName : 'QTY', width:80 },
