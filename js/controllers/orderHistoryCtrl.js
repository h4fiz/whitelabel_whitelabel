angular.module('app')
.controller('orderHistoryCtrl', ['$state', '$scope', '$timeout', '$interval', '$http', '$uibModal', '$q', '$rootScope', function($state, $scope, $timeout, $interval, $http, $uibModal, $q, $rootScope){
    ...
    $scope.getOrderList = function(){
        ...
        $http.get('http://18.141.18.7/controlpanel/getOrderHistory.php?date='+year+month+date)		
		.success(function(respone) 
		{
            respone = CRYPTO.decrypt(respone.data);
            console.log(respone);
