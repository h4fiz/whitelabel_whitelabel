...
.controller('zoomPartnerCtrl', ['$state', '$scope', '$timeout', '$interval', '$http', '$uibModal', '$q', '$rootScope', function($state, $scope, $timeout, $interval, $http, $uibModal, $q, $rootScope){
    ...
    $scope.getList = function(){
        ...
        var url = 'http://apps.zoomitnow.co/controlpanel/getPartnerList.php';
        if(usingDevelopment)
...
.controller('PartnerModalCtrl', ['$scope', '$uibModalInstance', 'dataPartner', '$http', '$uibModal', function ($scope, $uibModalInstance, dataPartner, $http, $uibModal) {
    ...
    $scope.getBillingType= function(){
            ...
            var url = 'http://apps.zoomitnow.co/controlpanel/getBillingType.php';
            if(usingDevelopment)
	...
	$scope.getPartnerType= function(){
            ...
            var url = 'http://apps.zoomitnow.co/controlpanel/getPartnerType.php';
            if(usingDevelopment)
    ...
    $scope.getPartnerGroup= function(){
            ...
            var url = 'http://apps.zoomitnow.co/controlpanel/getPartnerGroup.php';
            if(usingDevelopment)
    ...
    $scope.submit = function(){
        ...
        var url = 'http://apps.zoomitnow.co/controlpanel/editPartner.php';
        if(usingDevelopment)
            url = serverDevelopment+"/controlpanel/editPartner.php";
        if($scope.input.id == 0){
            url = 'http://apps.zoomitnow.co/controlpanel/addPartner.php';
            if(usingDevelopment)
...
function ($scope, $uibModalInstance, dataInput, $http, $uibModal) {
    ...
    $scope.getListAddress = function(){
        ...
        var url = 'http://apps.zoomitnow.co/controlpanel/getListPartnerOutletAddress.php';
        if(usingDevelopment)
    ...
    $scope.addAddress = function(dataPartner){
        ...
        var jsonData = CRYPTO.encrypt(data);
        var url = 'http://apps.zoomitnow.co/controlpanel/addPartnerOutletAddress.php';
        if(usingDevelopment)
    ...
    $scope.deleteAddress = function(outletData){
        ...
        var jsonData = CRYPTO.encrypt(data);
        var url = 'http://apps.zoomitnow.co/controlpanel/deletePartnerOutletAddress.php';
        if(usingDevelopment)
